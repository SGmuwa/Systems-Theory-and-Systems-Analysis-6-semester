...
namespace lab3
{
    class Program
    {
        ...
        {//Создается 10 муравьев
            ...
            path18.setIdAnt(18);
            List<int> pathlist18 = new List<int>();
            path18.setPath(pathlist18);
            List<double> masVesov18 = new List<double>();
            path18.setMasVesov(masVesov18);
            list_cur_path.Add(path18);

            CurrentPath path19 = new CurrentPath();
            path19.setIdAnt(19);
            List<int> pathlist19 = new List<int>();
            path19.setPath(pathlist19);
            List<double> masVesov19 = new List<double>();
